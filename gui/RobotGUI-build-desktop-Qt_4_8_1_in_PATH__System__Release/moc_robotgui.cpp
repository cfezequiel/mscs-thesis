...
**
** Created: Tue Nov 13 17:28:02 2012
...
static const char qt_meta_stringdata_robotGui[] = {
    "robotGui\0"
};
...
const QMetaObjectExtraData robotGui::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject robotGui::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_robotGui,
      qt_meta_data_robotGui, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &robotGui::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_robotGui))
